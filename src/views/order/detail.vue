    ...
    <div class="detail-content">
      <div class="detail-status">
        <img
          :src="
            getIcon(
              [failIcon, pendingIcon, successIcon][detail?.status.code + 1],
            )
          "
          alt=""
        />
        <div
          :class="{
            'green-text': detail?.status.code == 1,
            'red-text': detail?.status.code == -1,
          }"
        >
          {{ detail?.status.msg }}
        </div>
      ...
      <div class="detail-type">
        ...
        <div class="detail-type-content" v-else>
          <img
            :src="getIcon(detail?.sourceChain?.icon)"
            class="detail-type-img"
            alt=""
          />
          <span>{{ detail?.sourceChain?.name }}</span>
          <img
            src="@/assets/icon_arrow_right.png"
            class="detail-type-arrow"
            alt=""
          />
          <img
            :src="getIcon(detail?.targetChain?.icon)"
            class="detail-type-img"
            alt=""
          />
...
const dataStrs = [
  {
    title:
      i18n.global.messages.value[i18n.global.locale.value].order
        .transferQuantity,
    code: "amount",
  },
  {
    title:
      i18n.global.messages.value[i18n.global.locale.value].order.receiveNum,
    code: "receiveNum",
  },
  {
  ...
  {
    title:
      i18n.global.messages.value[i18n.global.locale.value].order.targetAddress,
    code: "targetAddress",
  },
  {
    title:
      i18n.global.messages.value[i18n.global.locale.value].order.sourceAddress,
    code: "sourceAddress",
  },
  {
  ...
  {
    title:
      i18n.global.messages.value[i18n.global.locale.value].order.createTime,
    code: "createTime",
  },
];
onMounted(() => {
